...
$CMD ./hotrace < $DIR/$TEST1 > out/out1

printf "${YELLOW}$TEST2${NC}"
$CMD ./hotrace < $DIR/$TEST2 > out/out2

printf "${YELLOW}$TEST3${NC}"
$CMD ./hotrace < $DIR/$TEST3 > out/out3

printf "${YELLOW}$TEST4${NC}"
$CMD ./hotrace < $DIR/$TEST4 > out/out4

printf "${YELLOW}$TEST5${NC}"
$CMD ./hotrace < $DIR/$TEST5 > out/out5

printf "${YELLOW}$TEST6${NC}"
$CMD ./hotrace < $DIR/$TEST6 > out/out6

printf "${YELLOW}$TEST7${NC}"
$CMD ./hotrace < $DIR/$TEST7 > out/out7
